...
from sglang.srt.configs.llada_fast import LLaDAFastConfigAdapter, _is_llada_fast_config
...
class ModelRunner(ModelRunnerKVCacheMixin):
    ...
    @property
    def llada_fast_config(self):
        config = self.model_config.hf_config
        if _is_llada_fast_config(config):
            return LLaDAFastConfigAdapter(config)
        return None
